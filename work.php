        ...
        <nav class="nav container">
            ...
            <div class="nav__menu">
                <ul class="nav__list">
                    ...
                    <li class="nav__item">
                        <a href="work.php" class="nav__link active-link">
...
<section class="work section" id="work">
    ...
    <h2 class="section__title">My Latest Works</h2>

    <div class="work__filters"> 
        <span class="work__item active-work" data-filter="all">All</span>
        <span class="work__item" data-filter=".sites">Sites</span>
        <span class="work__item" data-filter=".apps">Apps</span>
        <span class="work__item" data-filter=".ui">UI</span>
    </div>

    <div class="work__container container grid">
        <div class="work__card mix apps sites">
            <img src="./assets/img/" alt="" class="work__img">

            <h3 class="work__title">TO BE UPLOADED</h3>

            <a href="#" target="_blank" class="work__button">
                Read More
...
<footer class="footer">
    <div class="footer__container container">
        ...
        <ul class="footer__social">
            ...
            <a href="hhttps://www.instagram.com/jlriveraa_19" target="_blank" class="footer__social-link">
